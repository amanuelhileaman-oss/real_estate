          ...
          <div className="flex items-center p-1 bg-white rounded-xl border border-slate-200 overflow-x-auto shadow-sm">
            {[
              ...
              <button
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all whitespace-nowrap ${roleFilter === tab.value
                  ...
                  {users.map((u) => {
                    ...
                    return (
                      <tr key={u.id} className="hover:bg-slate-50/70 transition-colors">
                        ...
                        <td className="py-3.5 px-4">
                          <span
                            className={`inline-flex items-center gap-1.5 text-[11px] font-semibold px-2 py-0.5 rounded-full ${u.is_active
                          ...
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            {isAgent && (
                              <button
                                ...
                                className={`px-2 py-1 text-[10px] font-bold rounded-lg transition-colors border cursor-pointer ${isVerified
                            ...
                            {u.role !== 'ADMIN' && (
                              <button
                                ...
                                className={`px-2 py-1 text-[10px] font-bold rounded-lg transition-colors cursor-pointer ${u.is_active
              ...
              <div className="p-6 space-y-5 text-xs">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-3 bg-slate-50 rounded-xl space-y-1">
                    ...
                    <div>
                      <span
                        className={`inline-flex items-center gap-1 font-semibold ${selectedUser.is_active ? 'text-emerald-600' : 'text-rose-600'
                          }`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${selectedUser.is_active ? 'bg-emerald-500' : 'bg-rose-500'
                            }`}
                        />
